...
export function RevenueForm({ scenario, onPatch }:{ scenario: Scenario; onPatch:(p:Partial<Scenario>)=>void }){
  ...
  return (
    <div className="card p-4 space-y-3">
      <h3 className="text-lg">Revenues</h3>
      <div className="grid md:grid-cols-2 gap-3">
        <label className="block text-sm">
          <span className="text-muted-300">Members</span>
          <input type="number" className="w-full p-2 mt-1 bg-ink-700 rounded-xl" value={rev.membership.members}
      ...
      <div className="grid md:grid-cols-2 gap-3">
        <label className="block text-sm">
          ...
          <input type="number" className="w-full p-2 mt-1 bg-ink-700 rounded-xl" value={rev.events.perMonth}
      ...
      <div className="grid md:grid-cols-3 gap-3 items-end">
        <label className="block text-sm">
          ...
          <select className="w-full p-2 mt-1 bg-ink-700 rounded-xl" value={(rev.fnb as any).method}
            onChange={e=> {
