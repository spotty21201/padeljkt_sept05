...
export function PaybackTimelineChart({ data, bepYear, variant="dark", tickSize=12 }:{ data:{ year:number; cumulative:number }[]; bepYear?: number | null; variant?: "dark"|"light"; tickSize?: number }){
